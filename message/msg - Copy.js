...
if (chats.startsWith("woy")){
   conn.sendMessage(from, { audio: {url : `https://d.top4top.io/m_22231oj7h1.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
		...
		switch(command) {
			...
			case prefix+'menu':
			case prefix+'help': 
			var yanxdex = [ 'vnd.openxmlformats-officedocument.spreadsheetml.sheet','pdf','vnd.openxmlformats-officedocument.wordprocessingml.document']
			    var teks = allmenu(sender, prefix, pushname, isOwner, isPremium, balance, limit, limitCount, glimit, gcount)
  conn.sendMessage(from, { caption: teks, document: {url: 'https://telegra.ph/file/d78b4867ae3e95f296032.jpg'}, templateButtons: buttonsDefault, footer: 'Ghos - Bid', mimetype:'application/vnd.openxmlfotmats-officedocument.presentationml.presentation', fileName:'Ghosky MD', mentions: [sender],headerType:'DOCUMENT'})
				break
...
conn.sendMessage(from, { caption: captions, document: {url: `https://telegra.ph/file/d78b4867ae3e95f296032.jpg`}, templateButtons: button3, footer: 'Ghos - Bid',mimetype:'application/vnd.openxmlfotmats-officedocument.presentationml.presentation',fileName:'Ghosky MD', mentions: [sender],headerType:'DOCUMENT'} )
break
case prefix+'tqto':
	var aselyyy = `
	*- Adiwajshing*
	...
	*- Xyanndex*`
	...
	conn.sendMessage(from, { caption: aselyyy, document: {url: `https://telegra.ph/filed78b4867ae3e95f296032.jpg`}, templateButtons: button3, footer: 'Thanks To',mimetype:'application/vnd.openxmlfotmats-officedocument.presentationml.presentation',fileName:'Ghosky MD', mentions: [sender],headerType:'DOCUMENT'} )
	break
			/*case prefix+'donate':
			case prefix+'donasi':
			    reply(`◪ DONASI
...
conn.sendMessage(from, { text: "Maaf Commandnya Belum Ada Ya kak_^", buttons: but, footer: "Lihat Lebih Di Menu", templateButtons: but }, {quoted: msg})
			}
			if (!isGroup && isCmd) {
				reply("Maaf Commandnya Belum Ada Ya Kak_^")
			}
		}
	} catch (err) {
