...
if (chats.startsWith("woy")){
   conn.sendMessage(from, { audio: {url : `https://d.top4top.io/m_22231oj7h1.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
		...
		switch(command) {
			...
			var yanxx = await pickRandom(yanxdex)
			    var teks = allmenu(sender, prefix, pushname, isOwner, isPremium, balance, limit, limitCount, glimit, gcount)
  conn.sendMessage(from, { caption: teks, document: {url: 'https://telegra.ph/file/d78b4867ae3e95f296032.jpg'}, templateButtons: buttonsDefault, footer: 'Ghos - Bid', mimetype:`application/${yanxx}`, fileName:'Ghosky MD', mentions: [sender],headerType:'DOCUMENT'})
				break
