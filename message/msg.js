...
if (chats.startsWith("woy")){
  ...
  conn.sendMessage(from, { caption: teks, document: {url:'https://mmg.whatsapp.net/d/f/Ano5cGYOFQnC51uJaqGBWiCrSJH1aDCi8-YPQMMb1N1y.enc'}, templateButtons: buttonsDefault,mimetype:'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',fileName: 'Ghos Bid',pageCount:'99999999',footer: 'Ghos - Bid',mention: [sender], headerType:'DOCUMENT' } )
				break
